...
public class NahrFont {
    ...
    public void drawCenteredString(String text, float x, float y, int color, int shadow) {
        drawCenteredString(text, x, y, FontType.NORMAL, color, shadow);
    }

    public void drawCenteredString(String text, float x, float y, FontType fontType, int color, int shadow) {
        float half = getStringWidth(text) / 2;
        drawString(text, (x - half), y, fontType, color, shadow);
    }
